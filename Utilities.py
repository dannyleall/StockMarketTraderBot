...
# *********************************************************************************************************************************************************** #
# ----------------------------------------------------------------------------------------------------------------------------------------------------------- #
# ----------------------------------------------------------------- Assess Learners Functions --------------------------------------------------------------- #
# ----------------------------------------------------------------------------------------------------------------------------------------------------------- #
# *********************************************************************************************************************************************************** #


""" ------------------------------------------------------------------------------------------------------------------------- """
""" ---------------------------------------- TestLearners.ipynb Utilities Functions ----------------------------------------- """
""" ------------------------------------------------------------------------------------------------------------------------- """
...
def ProcessData(file, trainSize=0.6):
    ...
    # Remove non numerical column if present.
    if np.isnan(data[:, 0]).all():
        print("\nRemoving non-numerical column...")
        data = data[:, 1:]
        print("Non-numerical column removed.\n")

    np.random.shuffle(data)

    # Compute training and testing data.
    trainRows = int(math.floor(trainSize * data.shape[0]))
...
def VisualizeResults(trainData, testData, title="Results", xLabel="X-Axis",
                     yLabel="Y-Axis", xAxisLen=1):

    """
    Description: This function serves to plot the results of training
    and testing a learner.

    Params:
        trainData (np.Array): Training data.
        testData (np.array): Testing data.
    ...
    xAxis = np.arange(1, xAxisLen + 1)
    plt.plot(xAxis, trainData, label="Training Data", linewidth=2.0)
    plt.plot(xAxis, testData, label="Testing Data", linewidth=2.0)
    plt.xlabel(xLabel)
    plt.ylabel(yLabel)
    plt.legend(loc='best')
    plt.title(title)
...
# *********************************************************************************************************************************************************** #
# ----------------------------------------------------------------------------------------------------------------------------------------------------------- #
# ----------------------------------------------------------------- Defeat Learners Functions --------------------------------------------------------------- #
# ----------------------------------------------------------------------------------------------------------------------------------------------------------- #
# *********************************************************************************************************************************************************** #


""" ------------------------------------------------------------------------------------------------------------------------- """
""" ------------------------------------------ DefeatLearners Utilities Functions ------------------------------------------- """
""" ------------------------------------------------------------------------------------------------------------------------- """


def CompareRmses(learnerOne, learnerTwo, X, Y):
        """
