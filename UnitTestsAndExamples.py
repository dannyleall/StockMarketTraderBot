...
def SliceRowUnitTests():
    ...
    print(SliceRow(HistoricalData(['AAPL', 'MSFT', 'TWTR', 'IBM', 'AMZN'], "2020-01-01", "2021-09-09"), "2020-01-01", "2009-01-31"))
...
def SliceColumnAndRowUnitTests():
    
    print("\n\n\nSliceColumnAndRow Success Tests:")
    print(SliceColumn(HistoricalData(['AAPL', 'MSFT', 'TWTR', 'IBM', 'AMZN'], "2020-01-01", "2021-09-09"), ['SPY']))

    print("\n\n\nSliceColumnAndRow Error Tests\ndfArray Error Test:")
...
def ComputeSharpeRatioUnitTests():
    ...
    allocations = [0.05, 0.10, 0.05, 0.10, 0.15, 0.25, 0.15, 0.15]
    print(ComputeSharpeRatio(price, 252, "2020-01-01", "2021-09-09", allocations))

    print("\n\n\nComputeSharpeRatio Weekly Success Tests:")    
    print(ComputeSharpeRatio(price, 52, "2020-01-01", "2021-09-09", allocations))

    print("\n\n\nComputeSharpeRatio Monthly Success Tests:")
    print(ComputeSharpeRatio(price, 12, "2020-01-01", "2021-09-09", allocations))

    print("\n\n\nComputeSharpeRatio Error Tests\ndfarray Error Test:")
    ComputeSharpeRatio(['XOM', 'GE', 'JPM', 'BP', 'AMZN', 'MSFT', 'AAPL', 'GOOGL'], 252, "2020-01-01", "2021-09-09", allocations)       # dfarray error
    
    print("\n\n\nComputeSharpeRatio Error Tests\nk Error Test:")
    ComputeSharpeRatio(price, 100, "2020-01-01", "2021-09-09", allocations)     # k error

    print("\n\n\nComputeSharpeRatio Error Tests\nTimeFrame Error Test:")
    ComputeSharpeRatio(price, 252, "2021-09-09", "2020-01-01", allocations)     # TimeFrame error
    
    print("\n\n\nComputeSharpeRatio Error Tests\nallocations Error Test:")
    ComputeSharpeRatio(price, 252, "2020-01-01", "2021-09-09", ['XOM', 'GE', 'JPM', 'BP', 'AMZN', 'MSFT', 'AAPL', 'GOOGL'])     # allocations error



# OptimizePortfolio Tests
def MonteCarloOptimizationUnitTest():
...
def ML4TProfessorExample():
    ...
    prevOptFuncAlloc = OptimizePortfolio(symbols, 20000, startDate, endDate)
...
# SPY stock graph from 2009 tp 2013   /////    Video: #5 How to plot a hisogram.  /////   TimeStamp: 0:51 
def SevenExampleOne():
...
# Daily returns histogram for SPY with 10 and 20 bins.    /////   Video: #5 How to plot a histogram.  /////   TimeStamp: 1:14 
def SevenExampleThree():
    PlotHistogram(StockReturns(HistoricalData(['SPY'], "2009-01-01", "2012-12-31"), "daily"), "No", 10)
